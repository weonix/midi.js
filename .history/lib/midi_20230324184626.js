...
/***/ function(module, exports, __webpack_require__) {
	...
	*/
	...
	(function () {
	  ...
	  var scheduleTracking = function scheduleTracking(channel, note, currentTime, offset, message, velocity, eventObj) {
	    return setTimeout(function () {
	      var data = {
	        channel: channel,
	        note: note,
	      ...
	      switch (event.subtype) {
	        ...
	        case 'noteOn':
	          ...
	          eventQueue.push({
	            event: event,
	            time: queueTime,
	            source: _root2.default.noteOn(channelId, note, event.velocity, delay),
	        ...
	        case 'noteOff':
	          ...
	          eventQueue.push({
	            event: event,
	            time: queueTime,
	            source: _root2.default.noteOff(channelId, note, delay),
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.AudioContext && function () {
	  ...
	  midi.noteOn = function (channelId, noteId, velocity, delay) {
	    ...
	    //console.log(root.channels, channelId);
	    var channel = _root2.default.channels[channelId];
	    var instrument = channel.instrument;
	    var bufferId = instrument + '' + noteId;
	    var buffer = audioBuffers[bufferId];
	    //console.log(noteId, instrument);
	    if (!buffer) {
