...
(function () {
  ...
  var startAudio = function (currentTime, fromCache, onsuccess) {
    ...
    for (var n = 0; n < length && messages < 100; n++) {
     ...
     // var delay = ctx.currentTime + ((currentTime - 0.5 + foffset + player.startDelay) / 1000)
      var delay = ctx.currentTime - player.ctxStartTime + ((currentTime + player.startDelay) / 1000)
      console.log(ctx.currentTime, player.ctxStartTime, currentTime + player.startDelay)
