...
(function () {
  ...
  var startAudio = function (currentTime, fromCache, onsuccess) {
    ...
    // /
    //console.log(data);
    var allowedTimeStep = 3;
    for (var n = player.eventPosition; n < length && allowedTimeStep > 0; n++) {
      var obj = data[n];
      //console.log("-", obj);
      // console.log(currentTime, queuedTime, obj[0], obj[0].event);
      //console.log(queuedTime, obj[1], offset);

      ifplayer.getAudioContextPlaytime() >= (queuedTime / 1000) - player.minLookAheadTime
