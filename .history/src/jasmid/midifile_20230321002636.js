      ...
      if (eventTypeByte === 0xff) {
        ...
        switch (subtypeByte) {
          ...
          case 0x51:
            ...
            event.microsecondsPerBeat = (readInt8() << 16) + (readInt8() << 8) + readInt8();
            return event;
          case 0x54:
        ...
        event.type = 'sysEx';
        var _length = readVarInt();
        event.data = read(_length);
        return event;
      } else if (eventTypeByte === 0xf7) {
        event.type = 'dividedSysEx';
        var _length2 = readVarInt();
        event.data = read(_length2);
        return event;
      } else {
