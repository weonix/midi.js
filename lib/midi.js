	...
	(function () {
	  ...
	  player.startAudio = function (startTime) {
	    ...
	    for (var channelId in _root2.default.channels) {
	      ...
	      _root2.default.programChange([status, channel.instrument], channelId, channel.instrument, 0);
	    }
	        ...
	        switch (_context.prev = _context.next) {
	          case 0:
	            ...
	            try {
	              ...
	              player.replayer = new _jasmid.Replayer((0, _jasmid.MidiFile)(player.currentData), player.timeWarp, null, player.BPM, player.TimeSignitures);
	              player.data = player.replayer.getData();
	              player.endTime = getLength();
	              // /
	              // root.loadPlugin({
...
/***/ function(module, exports) {
	...
	function Replayer(midiFile, timeWarp, eventProcessor, bpm, inputTimeSignitures) {
	  var trackStates = [];
