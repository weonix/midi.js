...
/***/ function(module, exports) {
	...
	var MidiPlayer = function MidiPlayer() {
	    ...
	    this.stopAllNotes = function (delay, lookAhead) {
	        var stopImmediatelyIfPossible = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
...
/***/ function(module, exports, __webpack_require__) {
	            ...
	            return new Promise(function (resolve) {
	              (0, _utils.audioDetect)(function () {
	                var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(supports) {
	                  ...
	                  }, _callee, this, [[15, 26, 30, 38], [31,, 33, 37]]);
	                }));
	...
	*/
	      ...
	      return regeneratorRuntime.wrap(function _callee3$(_context3) {
	        while (1) {
	          switch (_context3.prev = _context3.next) {
	            case 0:
	              _context3.next = 2;
	              return _root2.default.WebMIDI.connect(opts);
	...
	var requestQueue = function requestQueue(opts, context, onFinish) {
	        ...
	        while (1) {
	          switch (_context5.prev = _context5.next) {
	            case 0:
	              ...
	              _context5.next = 4;
	              return _root2.default[context].connect(opts);
	  ...
	  var stopAudio = function stopAudio() {
	    ...
	    for (var key in noteRegistrar) {
	      ...
	      if (noteRegistrar[key].message === 144 && onMidiEvent) {
	        ...
	        onMidiEvent(event);
	        _root2.default.noteOff(event, o.channel, o.note, delay);
	      }
	    }
	
	    if (_root2.default.stopAllNotes) {
	      _root2.default.stopAllNotes(delay, player.minLookAheadTime, true);
	    }
	      ...
	      if (player.queuedTime < player.endTime) {
	        ...
	        for (var n = player.eventPosition; n < length; n++) {
	          ...
	          if (player.loopEnd != undefined) {
	            var ctxTime = player.getAudioContextPlaytime();
	          ...
	          if (player.insideLoop && player.loopEnd != undefined) {
	            if (player.queuedTime >= player.loopEnd * 1000 || player.queuedTime < player.loopStart * 1000) {
	              ...
	              _root2.default.stopAllNotes(stopNoteDelay, 0);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  midi.setController = function (event, channel, type, value, delay) {
	    ...
	    if (_root2.default.MidiChannelMapping[channel] != undefined) {
	      rawdata = midi.setEventChannel(rawdata, _root2.default.MidiChannelMapping[channel]);
	    }
	  ...
	  midi.setVolume = function (channel, volume, delay) {
	    ...
	    delay += midi.ctxStartTime;
	    if (_root2.default.MidiChannelMapping[channel] != undefined) {
	      channel = _root2.default.MidiChannelMapping[channel];
	    }
