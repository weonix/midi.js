...
/***/ function(module, exports) {
	...
	var MidiPlayer = function MidiPlayer() {
	    ...
	    this.stopAllNotes = function (lookAhead) {
	        for (var apiName in _this.API) {
	            var api = _this.API[apiName];
	            //console.log(api, api.enabled, api.avaliable)
	            if (api.enabled && api.avaliable) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  player.start = player.resume = function (onsuccess) {
	    ...
	    for (var api in _root2.default.API) {
	      if (_root2.default.API[api].avaliable) {
	        _root2.default.API[api].api.recordCtxStartTime();
	      }
	    }
	  ...
	  player.getContext = function () {
	    if (_root2.default.API.WebAudio.avaliable) {
	  ...
	  player.scheduleLoop = function () {
	    ...
	    loopHandler = setInterval(function () {
	      ...
	      for (var _note in noteOffRegistrar) {
	        ...
	        // }
	        if (noteOffRegistrar[_note].now <= player.getAudioContextPlaytime() * 1000) {
	          for (var noteOn in noteRegistrar) {
	            if (noteRegistrar[noteOn].note == noteOffRegistrar[_note].note) {
	  ...
	  _root2.default.setChannelMute = function (channelId, isMuted, delay) {
	    ...
	    if (isMuted) {
	      var objCopy = Object.assign({}, noteRegistrar);
	      console.log(objCopy);
	      for (var noteOn in noteRegistrar) {
	        var noteEvent = noteRegistrar[noteOn];
	        if (noteEvent.channel == channelId) {
	          _root2.default.noteOff(noteEvent, noteEvent.channel, noteEvent.channel, delay);
	        }
	      }
	    }
	  };
...
/***/ function(module, exports, __webpack_require__) {
	...
	window.AudioContext && function () {
	  ...
	  midi.recordCtxStartTime = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function () {
	  ...
	  midi.connect = function () {
	    var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(opts) {
	      var access, updateOutputList;
	      return regeneratorRuntime.wrap(function _callee$(_context) {
	        while (1) {
	          switch (_context.prev = _context.next) {
	            case 0:
	              updateOutputList = function updateOutputList() {
	                midi.outputs.clear();
